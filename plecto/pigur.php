        ...
        <div class="row" >
            <form id="main-form" action="openLead.php" class="" method="post" >
                <div class="form-group">
                    ...
                    <input type="hidden" class="input-group form-control" value="pigur" name="leadType"/>
                </div>
                <div class="row" >
                    <div class="col-xs-4"></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label for="sel1">מספר פוליסה בפיגור</label>
                        <input required type="number" class="input-group form-control" placeholder="מספר פוליסה בפיגור" name="pigurPolicy"/>
                    </div>
                </div>
                <div class="row" >
                    <div class="col-xs-4 "></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <input required type="number" class="input-group form-control" placeholder="פרמיה חודשית" name="premiaBepigur"/>
                    </div>
                </div>
                <div class="row" >
                    <div class="col-xs-4 "></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label for="sel1">מספר חודשי פיגור</label>
                        <input required type="number" class="input-group form-control" placeholder="מספר חודשי פיגור" name="pigurMonths"/>
                    </div>
                </div>
                <div class="row" >
                    <div class="col-xs-4 "></div>
