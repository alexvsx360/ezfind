        ...
        <div class="row" >
            <form id="main-form" action="openLead.php" class="" method="post" >
                <div class="form-group">
                    ...
                    <input type="hidden" class="input-group form-control" value="doublePay" name="leadType"/>
                </div>
                <div class="row" >
                    <div class="col-xs-4"></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label for="sel1">תאריך תחילת ביטוח</label>
                        <input required type="date" class="input-group form-control date"  name="insuranceStarDate"/>
                    </div>
                </div>
                <div class="row" >
                    <div class="col-xs-4"></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label for="sel1">תאריך תחילת ביטול</label>
                        <input required type="date" class="input-group form-control date"  name="cancelStartDate"/>
                    </div>
                </div>
                <div class="row" >
                    <div class="col-xs-4 "></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <select required class="form-control" id="cancelType" name="isCancelLetter">
                ...
                <div class="row" >
                    <div class="col-xs-4 "></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label for="sel1">באיזה חברה צריך לבטל?	</label>
                        <select required class="form-control" id="cancelInsuranceCompany" name="cancelInsuranceCompany">
                ...
                <div class="row" >
                    <div class="col-xs-4 "></div>
                    <div class="col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label for="sel1">מספר חודשי כפל</label>
                        <input required type="number" class="input-group form-control" placeholder="מספר חודשי כפל" name="doublePaymentCount"/>
