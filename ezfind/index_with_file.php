...
<div class="container" role="main" id="back_form">
    ...
    <div class="row" >
        <form enctype="multipart/form-data" id="main-form" action="newSale_with_file.php" class="" method="post" >
            <div class="form-group">
                <input type="hidden" id="customerName" class="input-group form-control" value="<?php print $customerFullName; ?>"  name="customerName"/>
                <input type="hidden" class="input-group form-control" value="<?php print $customerPhone; ?>" name="customerPhone"/>
                <input type="hidden" id="customerSsn" class="input-group form-control" value="<?php print $ssn ?>"  name="customerSsn"/>
                ...
                <input type="hidden" id ="address" class="input-group form-control" value="<?php print $address ?>" name="address"/>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#main-form").submit(function () {
                if($("#customerSsn").val() == ""||$("#customerName").val() == ""||$("#address").val() == ""){
                    alert("הפרטים בטופס לא נקלטו כמו שצריך. עליך לסגור את הטופס, אם  עדיין לא שמרת את פרטי הליד עליך לשמור אותם עכשיו ואז לפתוח את הטופס ולמלאות בו את הפרטים שוב.");
                    return false;
                }else {
