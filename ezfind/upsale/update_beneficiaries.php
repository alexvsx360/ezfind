...
<div class="container" role="main" id="back_form">
    ...
    <form enctype="multipart/form-data" id="main-form" action="upsaleHandler.php" class="" method="post" >
        <div class="form-group">
            <input type="hidden" class="input-group form-control" value="update_beneficiaries"  name="typeForm"/>
            ...
            <input type="hidden" class="input-group form-control" value="עדכון מוטבים" name="operationType"/>
            <input type="hidden" class="input-group form-control" value="<?php if ($_GET['agentId']) { print $_GET['agentId']; } ?>"  name="agentId"/>
        </div>
        <div class="row justify-content-center">
            <div class="col-10">
                <label for="sel1"> למי מעדכנים מוטבים  - מועמד ראשי או משני</label>
                ...
                <br/>
                <div id="div_for_three_inputs">
                    <div id="span">
                        <i class="material-icons" id ="add_input_mutavim">add_circle</i>:מוטבים
                    </div>
                    <div  class="row justify-content-center form-row"  >
                        <div class="col">
                            <input type="text"  required class="form-control programNumber"  placeholder="מספר ת.ז" name="IDNumber[]" >
                        </div>

                        <div class="col">
                            <input type="text" required class="form-control insuranceCompany" placeholder="שם מלא " name="fullName[]">
                        </div>
                    </div>
                    <br/>
                    <div  class="row justify-content-center form-row"  >
                        ...
                        <div class="col">
                            <select required class="form-control"  placeholder="קרבה" name="relation[]">
                                <option disabled selected value> קרבה</option>
                                <option value="בעל/אישה">בעל/אישה</option>
                                <option value="ילד/ילדה">ילד/ילדה</option>
                                <option value="אבא/אמא">אבא/אמא</option>
