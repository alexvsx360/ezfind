...
<div class="container" role="main" id="back_form">
    ...
    <form enctype="multipart/form-data" id="main-form" onsubmit="return validateFileSize()" action="upsaleHandler.php" class="" method="post" >
        <div class="form-group">
            ...
            <input type="hidden" class="input-group form-control" value="עדכון פרטים" name="operationType"/>
            <input type="hidden" class="input-group form-control" value="<?php if ($_GET['agentId']) { print $_GET['agentId']; } ?>"  name="agentId"/>
        </div>
        <div class="row justify-content-center">
            <div class="col-10">
                <label for="sel1"> למי מעדכנים פרטים  - מועמד ראשי או משני</label>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <i class="material-icons" id ="add_input_program">add_circle</i>
                    <p>:קופות</p>
                </div>
            </div>
            <div id="div_for_three_inputs">
                <div  class="row justify-content-center form-row" style="margin-right:20px">
