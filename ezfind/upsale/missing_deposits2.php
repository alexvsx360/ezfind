...
<head>
    ...
    <title>חוב פיגורים/הפקדות חסרות</title>
</head>
<body>
<?php
...
<div class="container" role="main" id="back_form">
    ...
    <form enctype="multipart/form-data" id="main-form" onsubmit="return validateFileSize()" action="upsaleHandler.php" class="" method="post" >
        <div class="form-group">
            ...
            <input type="hidden" class="input-group form-control" value="חוב פיגורים/הפקדות חסרות" name="operationType"/>
            <input type="hidden" class="input-group form-control" value="<?php if ($_GET['agentId']) { print $_GET['agentId']; } ?>"  name="agentId"/>
        </div>
        <div class="row justify-content-center">
            <div class="col-10">
                <label for="sel1">למי מטפלים בפיגורים - מועמד ראשי או משני</label>
            ...
            <label for="sel1">סוג הפניה</label>
            <div class="input-group mb-3">
                <select class="custom-select" id="pedionType" name="reference_type">
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <label for="sel1">שם המעסיק</label>
                    <input required type="text" class="input-group form-control" placeholder="כתוב את השם המעסיק " name="employer_name"/>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-12">
            ...
            <div class="input-group mb-3">
                <select class="custom-select"   id="pedionType" name="pedionType">
                    <option selected > -- בחר את סוג הקופה -- </option>
                ...
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect01">:סוג הקופה</label>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-12">
