...
function getTicketId($campaignId,$leadToPopulateJson){
    switch ($campaignId){
        case 18491://ערוץ ביטולים
            return $leadToPopulateJson['lead']['fields']['103694'];
            break;
        default:
            return $leadToPopulateJson['lead']['fields']['102158'];
    }
}
