...
$('form').submit(function (event) {
    ...
    var data, xhr;
    var ssn = $('#ssn').val();
    var castumerLastName = $('#castumerLastName').val();
    var castumerFirstName = $('#castumerFirstName').val();
    var typeOfTicket = $('#typeOfTicket').val();
    if(fileList.length <= 0) {
        $('#alertNotFile').css("visibility","visible");
        ...
        data.append("castumerLastName", castumerLastName);
        data.append("castumerFirstName", castumerFirstName);
        data.append("typeOfTicket", typeOfTicket);
        data.append("ssn", ssn);
        xhr = new XMLHttpRequest();
        xhr.open( 'POST','uploadFilesTofaxesQueueHendler.php', true );
