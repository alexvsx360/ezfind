                            ...
                            <form action="redirect.php" method="post" id="uploadForm" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" class="input-group form-control" value="<?php if ($_GET['recordNumber']) {
                                            print $_GET['recordNumber'];
} ?>"  name="recordNumber"/>  
                                        <input type="hidden" class="input-group form-control" value="<?php if ($_GET['crmAcccountNumber']) {
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="input-group form-control" value="<?php if ($_GET['fileType']) {
                                        print $_GET['fileType']; } ?>" name="fileType"/>
                                </div>
                                <div class="form-group">
                                    <label for="sel1">קטגורית המסמך:</label>
                                    <select class="form-control" id="category" name="file_category">
